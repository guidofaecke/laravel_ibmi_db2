...
class DB2Grammar extends Grammar
{
    ...
    protected function modifyIncrement(Blueprint $blueprint, Fluent $column): ?string
    {
        if ($column->autoIncrement && in_array($column->type, $this->serials)) {
            return ' generated by default as identity constraint '
                . $blueprint->getTable()
                . '_'
                . $column->name
     ...
     * @return string
     */
    public function compileAddReplyListEntry(Blueprint $blueprint, Fluent $command, Connection $connection): string
    {
